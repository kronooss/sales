...
import { GridCell, GridCellKind, ImageCell, TextCell } from "@glideapps/glide-data-grid";
import { linkImage } from "@assets/images/confirm-order-bg.png";
...
export function readonlyImageCell(
  value: string,
  hasCursorPointer: boolean = true,
): TextCell {
  return {
